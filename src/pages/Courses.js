  ...
  return (<>
    <div className="Courses-Background">
      ...
      <div className="Courses-SubTitle">
        ...
        <ul>
        <div class="dropdown">
          <span><li>6.148 - Web Lab: A Web Programming Class and Competition</li></span>
          <div class="dropdown-content">
          <p>Student teams learn to design and build functional and user-friendly web applications. Topics include version control, HTML, CSS, JavaScript, ReactJS, and nodejs. All teams are eligible to enter a competition where sites are judged by industry experts. Beginners and experienced web programmers welcome, but some previous programming experience is recommended.</p>
          </div>
        </div>
        </ul>
        </div>
